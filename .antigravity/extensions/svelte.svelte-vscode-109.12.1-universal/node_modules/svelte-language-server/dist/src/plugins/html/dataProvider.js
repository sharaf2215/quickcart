...
const svelteDirectiveKeywords = [
    ...
    {
        name: 'transition:',
        description: 'A transition is triggered by an element entering or leaving the DOM as a result of a state change.',
        references: [
            {
                name: 'Svelte.dev Reference',
    ...
    {
        name: 'in:',
        description: 'The in: and out: directives are identical to transition:, except that the resulting transitions are not bidirectional.',
        references: [
            {
                name: 'Svelte.dev Reference',
    ...
    {
        name: 'animate:',
        description: 'An animation is triggered when the contents of a keyed each block are re-ordered.',
        references: [
            {
                name: 'Svelte.dev Reference',
    ...
    {
        name: 'style:',
        description: 'The style: directive provides a shorthand for setting multiple styles on an element.',
        references: [
            {
                name: 'Svelte.dev Reference',
