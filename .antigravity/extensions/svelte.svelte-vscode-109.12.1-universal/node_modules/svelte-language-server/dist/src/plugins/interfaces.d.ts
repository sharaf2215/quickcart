...
export interface WorkspaceSymbolsProvider {
    getWorkspaceSymbols(query: string, cancellationToken?: CancellationToken): Resolvable<WorkspaceSymbol[] | null>;
}
